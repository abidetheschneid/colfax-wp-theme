...
<div id="title-wrap"<?php if(get_field('race_color') != ""): ?> class="<?php the_field('race_color'); ?>"<?php endif; ?>>
	...
	<div id="content" class="container">
		<div class="eleven columns">
			<?php if(get_field('page_header_img') != ""): ?>
				<div class="header-img">
					<img src="<?php the_field('page_header_img'); ?>" />
				</div>
			<?php endif; ?>
			<?php if(get_field('page_youtube') != ""): ?>
				<div class="video">
					<?php the_field('page_youtube'); ?>
				</div>
			<?php endif; ?>
			<?php the_content(); ?>
		...
		<div class="five columns">
			<div class="sidebar-wrap">
				<div class="sidebar race<?php if(get_field('race_color') != ""): ?> <?php the_field('race_color'); ?><?php endif; ?>">
					<div class="color-wrap">
						<h1<?php if(get_field('race_sidebar_header') != ""): ?> style="background-image:url(<?php the_field('race_sidebar_header'); ?>);"<?php endif; ?>>
							<?php if(get_field('race_sidebar_title') != ""): ?>
								<?php the_field('race_sidebar_title'); ?>
							<?php endif; ?>
						</h1>
					</div>
					<?php if(get_field('race_sidebar') != ""): ?>
						<?php the_field('race_sidebar'); ?>
					<?php endif; ?>
				</div>
			</div>
			...
			<?php if(get_field('race_sidebar_bottom_content')): ?>
				<div class="sidebar-wrap">
					<div class="sidebar-content">
						<?php the_field('race_sidebar_bottom_content'); ?>
					</div>
				</div>
			<?php endif; ?>
		</div>
