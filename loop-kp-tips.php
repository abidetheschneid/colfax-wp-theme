...
<div id="content-wrap">
	<div id="content" class="container">
		<div class="eleven columns">
			...
			<?php endwhile; ?>
			<?php if (have_posts()) : ?>
				<?php $query = new WP_Query(array('post_type' => 'kp-tips', 'posts_per_page' => 999, 'orderby' => 'date', 'order' => 'DESC')); while ( $query->have_posts() ) : $query->the_post(); ?>
						...
						<?php if(get_field('tip_logo') != ""): ?>
							<div class="logo-wrap">
								<a href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent link to <?php the_title(); ?>">
									<img src="<?php the_field('tip_logo'); ?>" />
								</a>
							</div>
						<?php endif; ?>
						<?php the_excerpt(); ?>
