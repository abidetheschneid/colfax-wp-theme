	...
	<div id="content" class="container">
			...
			<div class="two-thirds column">
				<div class="home-hero">
					<?php if (get_field('home_primary_feature_label') != ""): ?>
						<h1><?= get_field('home_primary_feature_label'); ?></h1>
					<?php endif; ?>
					<?php if (get_field('home_primary_feature_photo') != ""): ?>
						<?php if (get_field('home_primary_feature_link') != ""): ?>
							<a href="<?= get_field('home_primary_feature_link'); ?>" class="image-link">
							<?php endif; ?>
							<img src="<?= get_field('home_primary_feature_photo'); ?>" />
							<?php if (get_field('home_primary_feature_link') != ""): ?>
							</a>
						<?php endif; ?>
					<?php endif; ?>
					<?php if (get_field('home_primary_feature_headline') != ""): ?>
						<h2><?= get_field('home_primary_feature_headline'); ?></h2>
					<?php endif; ?>
					<?php if (get_field('home_primary_feature_excerpt') != ""): ?>
						<?= get_field('home_primary_feature_excerpt'); ?>
					<?php endif; ?>
					<?php if (get_field('home_primary_feature_link') != ""): ?>
						<a href="<?= get_field('home_primary_feature_link'); ?>" class="more">
							<?php if (get_field('home_primary_feature_link_text') != ""): ?>
								<?= get_field('home_primary_feature_link_text'); ?>
							<?php endif; ?>
						</a>
					<?php endif; ?>
				</div>
			...
			<div class="one-third column">
				<div class="home-feature">
					<?php if (get_field('home_secondary_feature_label') != ""): ?>
						<h1><?= get_field('home_secondary_feature_label'); ?></h1>
					<?php endif; ?>
					<?php if (get_field('home_secondary_feature_select') == "video"): ?>
						<?php if (get_field('home_secondary_feature_video') != ""): ?>
							<div class="video">
								<?= get_field('home_secondary_feature_video'); ?>
							</div>
						<?php endif; ?>
					<?php else: ?>
						<?php if (get_field('home_secondary_feature_photo') != ""): ?>
							<?php if (get_field('home_secondary_feature_link') != ""): ?>
								<a href="<?= get_field('home_secondary_feature_link'); ?>" class="image-link">
								<?php endif; ?>
								<img src="<?= get_field('home_secondary_feature_photo'); ?>" />
								<?php if (get_field('home_secondary_feature_link') != ""): ?>
								</a>
							<?php endif; ?>
						<?php endif; ?>
					...
					<?php if (get_field('home_secondary_feature_headline') != ""): ?>
						<h3><?= get_field('home_secondary_feature_headline'); ?></h3>
					<?php endif; ?>
					<?php if (get_field('home_secondary_feature_excerpt') != ""): ?>
						<?= get_field('home_secondary_feature_excerpt'); ?>
					<?php endif; ?>
					<?php if (get_field('home_secondary_feature_link') != ""): ?>
						<a href="<?= get_field('home_secondary_feature_link'); ?>" class="more">
							<?php if (get_field('home_secondary_feature_link_text') != ""): ?>
								<?= get_field('home_secondary_feature_link_text'); ?>
							<?php endif; ?>
						</a>
					<?php endif; ?>
				</div>
		...
		<?php if (get_field('home_features')): ?>
			<div class="features-wrap">
				<div class="row">
					<?php $i = 1;
					while (has_sub_field('home_features')): ?>
						<div class="one-third column">
							<div class="home-feature">
