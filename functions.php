...
{
	wp_enqueue_script('mmenu', get_template_directory_uri() . '/js/jquery.mmenu.min.all.js', array('jquery'), '5.5.3', false);
	wp_enqueue_script('hoverIntent', get_template_directory_uri() . '/js/hoverIntent.js', array('jquery'), '1.0.0', false);
	wp_enqueue_script('superfish', get_template_directory_uri() . '/js/jquery.superfish.js', array('jquery'), '1.0.0', false);
	wp_enqueue_script('easyListSplitter', get_template_directory_uri() . '/js/jquery.easyListSplitter.js', array('jquery'), '1.0.2', false);
	if (is_front_page() || is_page('Test')) {
		wp_enqueue_script('royalslider', get_template_directory_uri() . '/js/jquery.royalslider.js', array('jquery'), '1.0.2', false);
	}
	wp_enqueue_script('colfax', get_template_directory_uri() . '/js/runcolfax.js', array('jquery'), COLFAX_THEME_VERSION, false);
}
