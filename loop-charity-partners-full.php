			...
			<div class="charities-wrap full-list">
				<div class="charities-list">
					...
					<?php while ($loop->have_posts()): $loop->the_post(); ?>
						...
						<div class="parent <?php foreach ($terms as $term): echo $term->slug . ' ';
											endforeach; ?>">
							<div class="charity-partner cf">
								<div class="logo">
									<?php if (get_field('charity_partner_logo') != ""): ?>
										<a href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent link to <?php the_title(); ?>">
											<img src="<?= get_field('charity_partner_logo'); ?>" />
										</a>
									<?php endif; ?>
								</div>
								<div class="description">
									...
									<?php if (get_field('charity_partner_link') != ""): ?>
										<a href="<?= get_field('charity_partner_link'); ?>" class="button" target="_blank" style="margin-top:15px;">Donate</a>
									<?php endif; ?>
								</div>
							</div>
						</div>
